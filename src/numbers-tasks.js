...
function numberToStringInBase(number, base) {
  return parseInt(number.toString(), 10).toString(base);
}
...
function isNumber(number) {
  return Number.isFinite(number) && Number.isNaN(number) !== number;
}
...
function getIntegerOnString(str, base) {
  return Number.parseInt(str, base) ? parseInt(str, base) : NaN;
}
